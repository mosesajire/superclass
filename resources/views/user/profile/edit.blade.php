...
@section('content')
    <p><a href="/user/profile/" class="btn btn-primary">Back</a></p>
    <div class="well">
        <legend>Edit Profile</legend>
        <form action="{!! action('User\ProfilesController@update', $user->id) !!}" class="form" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
