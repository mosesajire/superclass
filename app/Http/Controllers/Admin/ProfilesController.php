...
class ProfilesController extends Controller
{
    public function index() {
        ...
        return redirect('/admin/profile/' . $user_id);
    }
    ...
    public function show($id)
    {
        if(User::find($id))
        {
            ...
            {
                return redirect('/admin/dashboard')->with('error', 'Sorry, something went wrong. Access denied!');
            }
        }
        else
        {
            return redirect('/admin/dashboard')->with('error', 'Sorry, something went wrong. Please try again.');
        }
    }
    ...
    public function update(ProfileFormRequest $request, $id)
    {
        if(User::find($id))
        {
            if(auth()->user()->id == $id)
            {
                ...
                return redirect('/admin/profile/' . $id)->with('success', 'You have updated a user successfully.');
